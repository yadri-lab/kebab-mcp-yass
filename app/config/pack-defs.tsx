...
export const PACKS: ConnectorDef[] = [
  ...
  },
  {
    ...
    vars: [
      ...
      // Phase 72 (D-72): the default-account vars (UNIPILE_LINKEDIN_ACCOUNT_ID /
      // UNIPILE_WHATSAPP_ACCOUNT_ID) are intentionally NOT listed here. Raw
      // account-id text fields are hostile (opaque ids). They are instead set
      // via the <UnipileAccountSelector> dropdown rendered under this form,
      // which lists accounts by name. Manual entry stays available behind an
      // "advanced" disclosure inside that component for the rare fallback case.
    ],
  },
  {
    id: "github",
